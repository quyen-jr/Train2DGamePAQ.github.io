class StartMenu extends Phaser.Scene {
    ...
    addStartButton() {
        this.startButton = this.add.sprite(640, 445, "startMenuButtons", "normalButton").setInteractive().setAlpha(0.9);
        this.add.text(575, 425, 'Play Game', { fontFamily: 'Fantasy', fontSize: '32px' });
        this.startButton.on('pointerover', () => { this.setButtonEvent(this.startButton, "hoverButton"); }, this);
    ...
    startGame() {
        this.startButton.setFrame("clickButton")
