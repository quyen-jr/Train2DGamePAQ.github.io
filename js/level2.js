class Level2 extends Phaser.Scene{
    ...
    create(){
        ...
        // dont change anything it will be lead to  errors
        this.level=2
        this.win=false;
    ...
    //#endregion
    addTransport() {
        this.trafficLight = this.add.sprite(575, 225, 'trafficLight').setScale(0.5).setRotation(Phaser.Math.DegToRad(-5)).setInteractive();
        this.train = this.add.sprite(0,-200, "train").setScale(0.37);
        this.car = this.add.sprite(400, 911, "car").setScale(0.85);
    ...
    addHouseStation() {
        this.house = this.add.sprite(245, 125, "houseStation").setScale(0.5).setRotation(Phaser.Math.DegToRad(132))
        this.house.setDisplaySize(200, 300)
    }

    addRoad2Image() {
        for (let i = -1; i < 16; i++) {
            this.add.sprite(133 + i * 60, 33 + i * 47, "roads", "straightRoad").setScale(0.45).rotation = Phaser.Math.DegToRad(129)
    ...
    addRoad1Image() {
        for (let i = -1; i < 13; i++) {
            this.add.sprite(875 - i * 46, 25 + i * 60, "roads", "straightRoad").setScale(0.45).rotation = Phaser.Math.DegToRad(39)
    ...
    addBackGround() {
        ...
        this.backgroundImage.setDisplaySize(gameWidth / 2, gameHeight / 2)
        // soil 
        this.soidImage =this.add.sprite(850,70,"straightSoilRoad").setScale(1.5).rotation = Phaser.Math.DegToRad(128);
       // this.soidImage =this.add.sprite(649,300,"straightSoilRoad").setScale(1.5).rotation = Phaser.Math.DegToRad(130);
        this.soidImage =this.add.sprite(425,600,"straightSoilRoad").setScale(1.5).rotation = Phaser.Math.DegToRad(127);
        this.soidImage =this.add.sprite(749,505,"straightSoilRoad").setScale(1.5).rotation = Phaser.Math.DegToRad(38);
        this.soidImage =this.add.sprite(950,665,"straightSoilRoad").setScale(1.5).rotation = Phaser.Math.DegToRad(39);
        this.curveSoidImage2 =this.add.sprite(449,64,"curveSoilRoad").setScale(1.5).rotation=Phaser.Math.DegToRad(38);
    ...
    createRoad1() {
        ...
        this.road = new Phaser.Curves.Path(975, -100);
        this.road.lineTo(238, 850);
    }
    createRoad2() {
        this.follower2 = { t: 0, vec: new Phaser.Math.Vector2() }
        // forr container
        ...
        this.followerContainer2 = { t: 0, vec: new Phaser.Math.Vector2() }
        this.followerContainer3 = { t: 0, vec: new Phaser.Math.Vector2() }
        this.road2 = new Phaser.Curves.Path(1115, 800)
        this.road2.lineTo(180 , 90)
