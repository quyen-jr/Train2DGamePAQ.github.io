class Button{
  constructor(scene,img,x,y,scale,scrollFactor,isCircle){
    ...
    this.body=this.scene.add.sprite(this.x,this.y,this.img) .setScale(this.scale).setScrollFactor(this.scrollFactor) 
  //  this.body.x=this.y
  //  this.body.x=this.x
